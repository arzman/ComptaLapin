...
public class EditCompteDialog extends ComptaDialog {
    ...
    public EditCompteDialog(AppCompte appCompte) {
        ...
        gbc.gridx = 0;
        gbc.gridy = row;
        content.add(new JLabel("Solde : "), gbc);
        gbc.gridx = 1;
        content.add(_soldeTxt, gbc);
        row++;

        gbc.gridx = 0;
        gbc.gridy = row;
        content.add(new JLabel("Est un livret : "), gbc);
        gbc.gridx = 1;
        content.add(_livretCheck, gbc);
        row++;

        gbc.gridx = 0;
        gbc.gridy = row;
        content.add(new JLabel("Budget : "), gbc);
        gbc.gridx = 1;
        content.add(_budgetCheck, gbc);
