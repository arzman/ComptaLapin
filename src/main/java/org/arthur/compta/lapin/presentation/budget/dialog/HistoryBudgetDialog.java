...
public class HistoryBudgetDialog extends ComptaDialog {
    ...
    public HistoryBudgetDialog(AppBudget app) {
        ...
        header.add(new JLabel(_appBudget.getNom()));
        header.add(new JLabel("Objectif : "));
        header.add(new JLabel(ApplicationFormatter.montantFormat.format(_appBudget.getObjectif())));
        header.add(new JLabel("Utilisé : "));
        header.add(new JLabel(ApplicationFormatter.montantFormat.format(_appBudget.getMontantUtilise())));
    ...
    private static class UtilisationTableModel extends AbstractTableModel {
        ...
        public void setData(List<AppUtilisation> data) {
            _data = data;
            fireTableDataChanged();
        }
        public AppUtilisation getRow(int row) {
        ...
        public Object getValueAt(int row, int col) {
            ...
            switch (col) {
                case 0 :
                    return u.getNom();
                case 1 :
                    return u.getDate() != null ? ApplicationFormatter.databaseDateFormat.format(u.getDate()) : "";
                case 2 :
                    return ApplicationFormatter.montantFormat.format(u.getMontant());
                default :
                    return null;
            }
        }
