...
public class ExerciceMensuelPane extends JPanel {
    ...
    private <T extends AppOperation> void createContextMenu(JTable table,
        ...
        // Ajouter
        JMenuItem addOp = new JMenuItem("Ajouter",
        ...
        // Éditer
        JMenuItem editOp = new JMenuItem("Editer",
        ...
        // Supprimer
        JMenuItem removeOp = new JMenuItem("Supprimer",
        ...
        // Transférer
        JMenuItem transOp = new JMenuItem("Transférer",
                new ImageIcon(ImageLoader.getImageIcon(ImageLoader.TRANSFERT_IMG).getImage()));
