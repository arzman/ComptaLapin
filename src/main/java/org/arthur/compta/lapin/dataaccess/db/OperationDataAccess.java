...
public class OperationDataAccess extends ComptaDataAccess {
     ...
     */
    public Operation addOperation(String nom, double montant, OperationType type, EtatOperation etat, int compteSrcId,
            int compteCibleId, int appEmId) throws ComptaException {
     ...
     * @throws ComptaException
     */
    public List<OperationSearchResult> searchOperation(String lib, String montant, String tolerance)
            throws ComptaException {
